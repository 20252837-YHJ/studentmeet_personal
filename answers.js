...
const STUDENTS = [
  ...
  },
  {
    ...
    answers: [
      { qId: 1, question: "학기 초에 새 친구를 사귈 때 가장 좋아하는 방법은 무엇인가요?", text: "공통 관심사를 찾는 게 제일 효과적이더라고요. 저는 영화나 책 얘기를 꺼내면 대화가 잘 이어지는 편이에요. 취향이 맞으면 금방 친해져요.", date: "2025.03.06" },
      { qId: 2, question: "자신을 동물에 비유한다면 어떤 동물이고, 그 이유는 무엇인가요?", text: "부엉이요. 밤에 더 집중이 잘 되고, 조용히 관찰하는 걸 좋아해요. 말보다는 그림이나 글로 표현하는 걸 편하게 느껴요.", date: "2025.03.06" },
      { qId: 3, question: "지금 가장 빠져있는 취미나 관심사가 있다면 소개해 주세요.", text: "요즘 아날로그 사진에 빠져있어요. 필름카메라로 찍으면 나오는 결과물이 매번 달라서 재미있어요. 사진 같이 찍으러 가실 분 환영해요!", date: "2025.03.06" },
      { qId: 4, question: "스트레스를 받을 때 주로 어떻게 해소하나요?", text: "영화관에 혼자 가는 편이에요. 어두운 곳에서 큰 화면으로 몰입하면 잡생각이 사라져요. 아니면 스케치북에 낙서하다 보면 마음이 편해지기도 해요.", date: "2025.03.06" },
      { qId: 5, question: "이번 학기에 꼭 이루고 싶은 목표가 있나요?", text: "졸업 작품 준비를 잘 마무리하는 게 가장 큰 목표예요. 그리고 전공이 다른 친구들이랑 협업 프로젝트를 하나 해보고 싶어요. 디자인 + 개발 콜라보 도전해보고 싶어요!", date: "2025.03.06" },
    ],
  },
  {
    id: 3,
